    ...
    if (shouldInitialize) {
      ...
      const samplePosts: BlogPost[] = [
        ...
        },
        {
          ...
          category: "tech-ai",
          tags: ["машинно�� обучение", "транскрипция", "алгоритмы", "ИИ"],
          author: "andrey-shcherbina",
        ...
        },
        {
          ...
          excerpt:
            "Новый набор корпоративных функций для ��правления встречами в крупных организациях.",
          heroImage:
    ...
    const contentTemplates = {
      ...
      "vr-meetings": `
        ...
        <ol>
          ...
          <li><strong>Постепенное масштабирование</strong>: расширение на вс�� компанию</li>
        </ol>
