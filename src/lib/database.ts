    ...
    if (shouldInitialize) {
      ...
      const samplePosts: BlogPost[] = [
        // Технологии и ИИ (6 статей)
        {
          ...
          featured: true,
          seoTitle:
            "9 лучших расширений Chrome для преобразования речи в ��екст 2024",
          seoDescription:
  ...
  private getSampleContent(type: string): string {
    const contentTemplates = {
      ...
      "ai-future": `
        ...
        <h2 id="intro">Введение</h2>
        <p>По данным исследований, 67% руководителей считают, что ИИ кардинально изменит деловые коммуникации в ближа��шие 5 лет. Мы находимся на пороге революции в том, как проводятся встречи, принимаются решения и документируются результаты.</p>
        ...
        <blockquote>
          <p>"В будущем встречи станут более продуктивными, короткими и результативными благодаря ИИ-помощникам, ��оторые возьмут на себя рутинные задачи документирования и анализа."</p>
      ...
      `,
      "vr-meetings": `
        <p>Виртуальная реальность открывает новые горизонты для деловых встреч. Современные VR-платформы позволяют создавать иммерсивные пространства для командной ��аботы, где участники могут взаимодействовать с 3D-объектами и совместно решать задачи.</p>
      ...
      "burnout-prevention": `
        ...
        <p>Как распознать первые симптомы усталости от п��стоянных совещаний и видеоконференций.</p>
