    ...
    if (shouldInitialize) {
      ...
      const samplePosts: BlogPost[] = [
        ...
        },
        {
          ...
          category: "tech-ai",
          tags: ["распознавание речи", "ИИ", "2024", "т��хнологии"],
          author: "maria-petrov",
        ...
        },
        {
          ...
          title: "Сложные разговоры: ��ак проводить неприятные встречи",
  ...
  private getSampleContent(type: string): string {
    const contentTemplates = {
      "chrome-extensions": `
        ...
        <p>Технологии распознавания речи значительно продвинулись за последние годы. Современные алгоритмы машинного обучения позволяют достигать точност�� более 95% в идеальных условиях.</p>
        ...
        <div class="extension-card">
          ...
          <p>Уни��ерсальное расширение для голосового ввода в любых текстовых полях браузера. Поддерживает более 120 языков и диалектов.</p>
      ...
      "ai-future": `
        ...
        <p>Уже в 2025 ��оду ожидается появление систем, способных:</p>
        <ul>
      ...
      `,
      "vr-meetings": `
        <p class="lead">Виртуальная реальность ��ткрывает новые горизонты для деловых встреч. Современные VR-платформы позволяют создавать иммерсивные пространства для командной работы, где участники могут взаимодействовать с 3D-объектами и совместно решать задачи.</p>
        ...
        <ul>
          ...
          <li><strong>На 25% л��чшее запоминание</strong> обсуждаемой информации</li>
      ...
      "speech-tech": `
        ...
        <ul>
          ...
          <li><strong>Медицина</strong>: диктовка мед��цинских заключений</li>
        ...
        <ul>
          <li>Автоматическое оп��еделение языка</li>
        ...
        <h2 id="conclusion">Заключение</h2>
        <p>2024 год стал годом зрелости для технологий распознавания речи. Современные системы готовы для массового внедрения в бизнес-процес��ы и могут значительно повысить эффективность работы команд.</p>
      `,
      "online-meetings": `
        ...
        <ul>
          ...
          <li>Буферное время меж��у встречами</li>
        ...
        <div class="extension-card">
          <p><strong>Идеальная структура 60-минутной встр��чи:</strong></p>
          <ul>
