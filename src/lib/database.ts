    ...
    if (shouldInitialize) {
      ...
      const samplePosts: BlogPost[] = [
        ...
        },
        {
          ...
          title: "Запуск мобильного ��риложения mymeet.ai: встречи в кармане",
        ...
        },
        {
          ...
          excerpt:
            "Практические советы по ведению сложных перегов��ров и решению конфликтных ситуаций.",
          heroImage:
        ...
        // Истории клиентов (2 статьи)
        {
          ...
          excerpt:
            "История успеха технолог��ческого стартапа, который революционизировал свои рабочие процессы.",
          heroImage:
        ...
        },
        {
          ...
          category: "customer-stories",
          tags: ["ко��порация", "трансформация", "внедрение", "масштаб"],
          author: "team-mymeet",
  ...
  private getSampleContent(type: string): string {
    const contentTemplates = {
      "chrome-extensions": `
        ...
        <ul>
          <li>Говорить четко и в у��еренном темпе</li>
      ...
      `,
      "vr-meetings": `
        <p class="lead">Виртуальная реальность открывает новые горизонты для деловых встреч. Современные VR-платформы позволяют создавать иммерсивные пространства дл�� командной работы, где участники могут взаимодействовать с 3D-объектами и совместно решать задачи.</p>
        ...
        <div class="platform-card">
          ...
          <p><strong>Ключевые особенности:</strong></p>
          <ul>
            <li>Фотореалистичные а��атары</li>
      ...
      default: `
        ...
        <p>Здесь располагается основная часть статьи с деталь��ым раскрытием темы, примерами и практическими советами.</p>
