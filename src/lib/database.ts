    ...
    if (!localStorage.getItem(STORAGE_KEYS.CATEGORIES)) {
      const sampleCategories: BlogCategory[] = [
        ...
        },
        {
          ...
          slug: "sales-art",
          description: "Тех��ики и стратегии успешных продаж",
          color: "bg-red-600",
          postCount: 0,
        },
      ];
    ...
    if (shouldInitialize) {
      ...
      const samplePosts: BlogPost[] = [
        ...
        },
        {
          ...
          category: "product-news",
          tags: ["мобильн��е приложение", "iOS", "Android", "запуск"],
          author: "team-mymeet",
        ...
        },
        {
          ...
          title: "Kanban + Встречи: как синхронизир��вать планирование задач",
    ...
    const contentTemplates = {
      "chrome-extensions": `
        ...
        <div class="extension-card">
          ...
          <p><strong>Кл��чевые особенности:</strong></p>
          <ul>
        ...
        <p>Ниже пред��тавлено детальное сравнение всех рассмотренных расширений:</p>
      ...
      `,
      "kanban-meetings": `
        <p>Интеграция методологии Kanban с результатами встреч создает мощную систему управления задачами. Автоматическое создание карточек из решений встреч помогает не потерять важные догов��ренности.</p>
