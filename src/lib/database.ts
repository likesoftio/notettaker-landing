    ...
    const contentTemplates = {
      ...
      "vr-meetings": `
        ...
        <ul>
          ...
          <li><strong>Виртуальные прототипы</strong>: манипуляции с 3D-моделями продук��ов</li>
        ...
        <ol>
          ...
          <li><strong>Постепенное масштабирование</strong>: ра��ширение на всю компанию</li>
        </ol>
        ...
        <ul>
          ...
          <li><strong>ИИ-помощники</strong>: ав��оматическая организация встреч</li>
      ...
      "speech-tech": `
        ...
        <ul>
          ...
          <li>Адаптации к специфической те��минологии</li>
      ...
      "online-meetings": `
        ...
        <div class="extension-card">
          ...
          <ul>
            ...
            <li><strong>Отвлекающие факторы</strong>: м��нимизируйте шум и движение</li>
          </ul>
        </div>
        ...
        <h2 id="secret-3">3. Управление вре��енем</h2>
