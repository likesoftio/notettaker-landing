  ...
  private getSampleContent(type: string): string {
    const contentTemplates = {
      ...
      "vr-meetings": `
        ...
        <p>VR-технологии значительно повышают вовлеченность участников и позволяют создавать уникальный опыт сотрудничества, недоступный в ��радиционных видеоконференциях.</p>
