...
class BlogDatabase {
      ...
      const samplePosts: BlogPost[] = [
        ...
        // 5 новых статей для наполнения
        {
          ...
          tableOfContents: [
            ...
            { id: "collaboration", title: "Новые возможности сотрудничества", level: 2 },
        ...
        },
        {
          ...
          excerpt:
            "Практические советы по предотвращению эмоционального выгорания через правильную организацию рабочих вс��реч.",
          heroImage:
        ...
        },
        {
          ...
          tableOfContents: [
            ...
            { id: "team-collaboration", title: "Командная работа", level: 1 },
  ...
  private getSampleContent(type: string): string {
    const contentTemplates = {
      "chrome-extensions": `
        ...
        <div class="extension-card">
          ...
          <ul>
            ...
            <li>Настраиваемые гор��чие клавиши</li>
        ...
        <p>Расширения Chrome для преобразования речи в текст значительно повышают продуктивность рабо��ы. Выбор конкретного инструмента зависит от ваших потребностей и бюджета. Для базовых задач отлично подойдет Voice In, а для профессиональной работы с встречами рекомендуем попробовать mymeet.ai.</p>
      `,
      "ai-future": `
        ...
        <ul>
          ...
          <li><strong>Создавать ��водки</strong> и план действий</li>
        </ul>
      ...
      `,
      "burnout-prevention": `
        <p class="lead">Эмоциональное выгорание стало серьезной проблемой современного ра��очего мира. Неправильно организованные встречи часто становятся источником стресса и усталости для сотрудников.</p>
        ...
        <ul>
          <li>Асинх��онные обновления вместо статусных встреч</li>
        ...
        <h2 id="conclusion">Заключение</h2>
        <p>Здоровые встречи - это инвестиция в долгосрочную продуктивность команды. Профилактика выгорания начинается с осознанного ��одхода к планированию и проведению встреч.</p>
      `,
      "speech-tech": `
      ...
      "security-update": `
        ...
        <p>Внедрение end-to-end шифрования, улучшенная аутенти��икация и новые средства контроля доступа к данным.</p>
      ...
      `,
      default: `
        <p>Это образец к��нтента для статьи. В реальном приложении здесь будет полноценная статья с подробным содержанием, изображениями и структурированной информацией.</p>
