  ...
  private getSampleContent(type: string): string {
    const contentTemplates = {
      "chrome-extensions": `
        ...
        <p>Про��есс установки одинаков для всех расширений:</p>
        <ol>
      ...
      "ai-future": `
        ...
        <p>Сегодня большинство к��мпаний все еще полагается на традиционные методы ведения встреч. Однако ведущие технологические компании уже активно внедряют ИИ-решения для оптимизации рабочих процессов.</p>
      ...
      `,
      "security-update": `
        <p>В декабре 2024 года мы представляем масштабное обновление системы безопасности mymeet.ai. Новые протоколы шиф��ования и усиленная защита данных обеспечивают максимальную конфиденциальность ваших встреч.</p>
